  ...
  const handleFormSubmit = async () => {
    ...
    if (modalType === "Account") {
      ...
      if (isEditing) {
        ...
        try {
          const response = await axios.put('http://localhost:5000/api/accounts/${editItemId}', formData);
        ...
        try {
          const response = await axios.post('http://localhost:5000/api/add_account', {
      ...
      if (isEditing) {
        ...
        try {
          const response = await axios.put('http://localhost:5000/api/employees/${editItemId}', formData);
          if (response.status === 200) {
            fetchEmployees();
            fetchAccounts();
            handleCloseModal();
        ...
        // Add new employee
        try {
          const response = await axios.post('http://localhost:5000/api/add_employee', formData);
          if (response.status === 201) {
            fetchEmployees();
            handleCloseModal();
          }
